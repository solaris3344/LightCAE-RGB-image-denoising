...
CKPT_NAME     = "ablation_s25_dil1_scratch.pt"   # >>> ABLASYON (F): d=1
SCALE_FACTOR  = 10.0
...
class LightResBlock(nn.Module):
    ...
    def __init__(self, ch):
        ...
        self.body = nn.Sequential(
            # >>> ABLASYON (F): dilation 2 -> 1 (padding de 2 -> 1; TEK DEGISIKLIK BU)
...
def train():
    ...
    print("=" * 60)
    print("  ABLASYON F (varyant) — sigma=25 SIFIRDAN, dilation=1")
